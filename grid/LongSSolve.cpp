...
map<char, pair<long long, long long>> mapDir = {
    {'L', {0, -1}}, {'R', {0, 1}}, {'U', {-1, 0}}, {'D', {1, 0}}};
map<char, long long> dirOrder = {{'L', 1}, {'R', 0}, {'U', 3}, {'D', 2}};
...
void solve(long long pos, long long x, long long y) {
    if (x == 7 && y == 1) {
        ...
        // Optimization 3: Stop if separate board long longo 2 slides, both contain
